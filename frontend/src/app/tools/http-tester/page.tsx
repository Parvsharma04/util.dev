...
import { Send, Copy, Plus, X, Globe } from "lucide-react";
...
const HttpTester = () => {
  ...
  return (
    <ToolLayout title="HTTP Request Tester" description="Test API endpoints like Postman" category="Developer Tools" icon={Globe}>
