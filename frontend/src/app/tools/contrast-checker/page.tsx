...
const ContrastChecker = () => {
    ...
    const [passesAALarge, setPassesAALarge] = useState(true);
    const [passesAAA, setPassesAAA] = useState(true);
    const [passesAAALarge, setPassesAAALarge] = useState(true);

    useEffect(() => {
        const contrastRatio = getContrastRatio(foreground, background);
        setRatio(contrastRatio.toFixed(2));
        setPassesAA(contrastRatio >= 4.5);
        setPassesAALarge(contrastRatio >= 3.0);
        setPassesAAA(contrastRatio >= 7.0);
        setPassesAAALarge(contrastRatio >= 4.5);
