  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-slate-900">.env Formatter</h1>
          <p className="text-slate-600">Format and organize environment variables</p>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              <div>
                ...
                <p className="text-slate-600">Organize variables in alphabetical order for better readability</p>
              </div>
              <div>
                <h4 className="font-medium mb-2">Remove Empty Lines</h4>
                <p className="text-slate-600">Clean up the file by removing unnecessary empty lines</p>
              </div>
              <div>
                <h4 className="font-medium mb-2">Remove Comments</h4>
                <p className="text-slate-600">Strip out all comments to create a production-ready file</p>
              </div>
            </div>
          </CardContent>
        </Card>
