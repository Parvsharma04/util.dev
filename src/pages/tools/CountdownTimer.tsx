    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-slate-600">Create shareable countdown timers</p>
            ...
            <CardContent>
              {isExpired ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-slate-600">Your countdown has finished</p>
                </div>
              ) : (
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="text-center p-6 bg-slate-50 rounded-lg">
                    ...
                    <div className="text-sm text-slate-600 uppercase tracking-wide">Days</div>
                  </div>
                  ...
                  <div className="text-center p-6 bg-slate-50 rounded-lg">
                    ...
                    <div className="text-sm text-slate-600 uppercase tracking-wide">Hours</div>
                  </div>
                  ...
                  <div className="text-center p-6 bg-slate-50 rounded-lg">
                    ...
                    <div className="text-sm text-slate-600 uppercase tracking-wide">Minutes</div>
                  </div>
                  ...
                  <div className="text-center p-6 bg-slate-50 rounded-lg">
                    ...
                    <div className="text-sm text-slate-600 uppercase tracking-wide">Seconds</div>
                  </div>
                </div>
              )}
