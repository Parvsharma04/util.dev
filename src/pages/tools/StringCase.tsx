      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <div className="flex items-center gap-2 text-sm text-slate-500 mb-4">
            ...
            <span>→</span>
            <span className="text-slate-900">String Case Converter</span>
          </div>
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900">String Case Converter</h1>
              <p className="text-slate-600">Convert strings between different naming conventions</p>
            </div>
          </div>
          ...
          <Card className="lg:col-span-2">
            ...
            <CardContent>
              <div className="space-y-4">
                {cases.map((caseType) => (
                  <div key={caseType.name} className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
