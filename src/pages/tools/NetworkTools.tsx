  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-slate-900">Network Tools</h1>
          <p className="text-slate-600">Ping and traceroute visualization tools</p>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="space-y-1 max-h-64 overflow-y-auto">
                      {pingResults.map((ping, index) => (
                        <div key={index} className="flex items-center justify-between p-2 bg-slate-50 rounded text-sm font-mono">
                  ...
                  {tracerouteResults.map((hop, index) => (
                    <div key={index} className="flex items-center gap-4 p-3 border border-slate-200 rounded-lg">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-slate-600 font-mono">{hop.ip}</div>
                      </div>
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-xs text-slate-500">RTT</div>
                      </div>
