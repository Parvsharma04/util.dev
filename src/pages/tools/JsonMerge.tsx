  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-slate-900">JSON Merge Tool</h1>
          <p className="text-slate-600">Merge two JSON objects with different strategies</p>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              <div>
                ...
                <p className="text-slate-600">Properties from JSON2 override those in JSON1</p>
              </div>
              <div>
                <h4 className="font-medium mb-2">Preserve</h4>
                <p className="text-slate-600">Properties from JSON1 are preserved when conflicts occur</p>
              </div>
              <div>
                <h4 className="font-medium mb-2">Deep Merge</h4>
                <p className="text-slate-600">Recursively merge nested objects</p>
              </div>
            </div>
          </CardContent>
        </Card>
