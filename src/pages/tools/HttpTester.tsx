  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-slate-900">HTTP Request Tester</h1>
          <p className="text-slate-600">Test API endpoints like Postman</p>
            ...
            <CardContent>
              ...
              {loading && (
                <div className="text-center py-12">
                  ...
                  <p className="mt-4 text-slate-600">Sending request...</p>
                </div>
              )}
