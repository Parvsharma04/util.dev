      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <div className="flex items-center gap-2 text-sm text-slate-500 mb-4">
            ...
            <span>→</span>
            <span className="text-slate-900">JWT Decoder</span>
          </div>
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900">JWT Decoder</h1>
              <p className="text-slate-600">Decode JSON Web Tokens and view header, payload, and signature</p>
            </div>
          </div>
