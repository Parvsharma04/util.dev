      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <div className="flex items-center gap-2 text-sm text-slate-500 mb-4">
            ...
            <span>→</span>
            <span className="text-slate-900">Color Converter</span>
          </div>
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900">Color Converter</h1>
              <p className="text-slate-600">Convert between HEX, RGB, HSL, and other color formats</p>
            </div>
          </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                    <div>
                      ...
                      <div className="font-mono text-sm text-slate-900">{formats.hex}</div>
                    </div>
                    <Button
                      size="sm"
                      variant="outline"
                  ...
                  <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                    <div>
                      ...
                      <div className="font-mono text-sm text-slate-900">{formats.rgb}</div>
                    </div>
                    <Button
                      size="sm"
                      variant="outline"
                  ...
                  <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                    <div>
                      ...
                      <div className="font-mono text-sm text-slate-900">{formats.rgba}</div>
                    </div>
                    <Button
                      size="sm"
                      variant="outline"
                  ...
                  <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                    <div>
                      ...
                      <div className="font-mono text-sm text-slate-900">{formats.hsl}</div>
                    </div>
                    <Button
                      size="sm"
                      variant="outline"
                  ...
                  <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                    <div>
                      ...
                      <div className="font-mono text-sm text-slate-900">{formats.hsla}</div>
                    </div>
                    <Button
                      size="sm"
                      variant="outline"
