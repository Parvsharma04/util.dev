      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <div className="flex items-center gap-2 text-sm text-slate-500 mb-4">
            ...
            <span>→</span>
            <span className="text-slate-900">Hash Generator</span>
          </div>
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900">Hash Generator</h1>
              <p className="text-slate-600">Generate MD5, SHA1, SHA256, and SHA512 hashes</p>
            </div>
          </div>
              ...
              <div className="space-y-4">
                {["MD5", "SHA1", "SHA256", "SHA512"].map((algorithm) => (
                  <div key={algorithm} className="space-y-2">
                    ...
                    <div className="p-3 bg-slate-50 rounded-lg font-mono text-sm text-slate-900 break-all">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <p className="text-slate-600">128-bit hash. Fast but not cryptographically secure.</p>
                </div>
                <div>
                  <h4 className="font-medium mb-2">SHA1</h4>
                  <p className="text-slate-600">160-bit hash. Deprecated for security purposes.</p>
                </div>
                <div>
                  <h4 className="font-medium mb-2">SHA256</h4>
                  <p className="text-slate-600">256-bit hash. Widely used and secure.</p>
                </div>
                <div>
                  <h4 className="font-medium mb-2">SHA512</h4>
                  <p className="text-slate-600">512-bit hash. More secure, larger output.</p>
                </div>
              </div>
            </CardContent>
          </Card>
